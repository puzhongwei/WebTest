...
def main():
    ...
    #打开网页
    driver.get("https://www.jianxun.io/")
    driver.maximize_window()
    print(driver.title)
    #driver.find_element_by_class_name('login').click()
    driver.find_element_by_xpath('/html/body/div[1]/div[1]/div/div[3]/div/a[1]').click()
    time.sleep(3)
    ...
    #点击验证
    driver.find_element_by_class_name('account-footer').click()
